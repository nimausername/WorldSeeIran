...
export interface ThemeToggleProps
  ...
  /** Accessible label when switching to light mode. */
  lightLabel?: string;
  /** Accessible label when switching to dark mode. */
  darkLabel?: string;
}

/** Shared circle-blur reveal used by the dock control and the D hotkey. */
export const THEME_TOGGLE_CIRCLE = {
  variant: "circle-blur" as const,
  start: "bottom-right" as const,
};
